...
export const mockMovies: Movie[] = [
  ...
  },
  {
    ...
    title: 'Parasite',
    overview:
      "All unemployed, Ki-taek's family take peculiar interest in the wealthy and glamorous Parks for their livelihood until they get entangled in an unexpected incident.",
    poster_path: null,
    backdrop_path: null,
    vote_average: 8.5,
    vote_count: 17000,
  ...
  },
  {
    ...
    overview:
      "Peter Parker's secret identity is revealed to the entire world. Desperate for help, Peter turns to Doctor Strange.",
    poster_path: null,
    backdrop_path: null,
    vote_average: 8.3,
    vote_count: 20000,
...
export const mockMovieDetail: MovieDetail = {
  ...
  videos: {
    results: [
      { id: 'v1', key: 'YoHD9XEInc0', name: 'Inception Trailer', type: 'Trailer', site: 'YouTube' },
    ],
  },
  credits: {
    cast: [
...
export const getMockRows = () => [
  ...
  { title: '⭐ Top Rated', movies: mockMovies.slice(3, 12) },
  {
    ...
    movies: mockMovies.filter((m) => m.genre_ids.includes(28)).slice(0, 8),
  },
