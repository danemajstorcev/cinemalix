...
export default function MyListContent() {
  ...
  return (
    <div className="px-8 sm:px-12 lg:px-16 py-12">
      <h1 className="text-4xl sm:text-5xl font-bold text-white mb-8">My List</h1>

      {movies.length === 0 ? (
        <div className="text-center text-gray-400 py-12">
          <p className="text-lg font-semibold mb-2">No movies in your list yet</p>
          <p className="text-sm">Start adding movies by clicking the add button on movie cards</p>
        </div>
      ) : (
        <>
